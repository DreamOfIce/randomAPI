...
import { verifyGithubProxy } from './utils.js';
    ...
    members: {
      _githubAuth: {
        ...
        validate: (value, config) =>
          value || config._environment === 'development', // require on production enviroument
      },
      githubProxy: {
        accept: [true, false, 'auto'],
        default: 'auto',
